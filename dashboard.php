          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-md-4">
                <div
                  class="info-box"
                  onclick="window.location='location_search.php'"
                >
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"
                      >Check safety scores of areas</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div
                  class="info-box"
                  onclick="window.location='map_explore.php'"
                >
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"
                      >Explore safety zones visually</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div
                  class="info-box"
                  onclick="window.location='safety_ratings.php'"
                >
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"
                      >Charts of crime rates and areas</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div
                  class="info-box"
                  onclick="window.location='check_safety.php'"
                >
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"
                      >AI analysis of your route’s safety</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div
                  class="info-box"
                  onclick="window.location='identify_routes.php'"
                >
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"
                      >Suggests optimal paths based on crime data</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div
                  class="info-box"
                  onclick="window.location='understand_factors.php'"
                >
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text"
                      >Understanding Safety Factors</span
                    >
                    <span class="info-box-number"
                      >Make informed decisions about safety</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div
                  class="info-box"
                  onclick="window.location='legend_info.php'"
                >
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"
                      >Learn to interpret map safety ratings</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div
                  class="info-box"
                  onclick="window.location='send_notifications.php'"
                >
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"
                      >Get alerts for danger or changes nearby</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div
                  class="info-box"
                  onclick="window.location='emergency_calls.php'"
                >
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"
                      >Connect to help when you need it most</span
                    >
                  </div>
                </div>
              </div>
            ...
            <div class="dashboard-section">
              <div class="card">
                ...
                <div class="card-body">
                  <p class="mb-4">
                    Real-time safety analytics and trends in Dhaka based on
                    AI-powered data collection. Click on each chart to interact
                    and explore.
                  </p>
                  <div class="row">
                    <!-- Crime by Area -->
                    <div class="col-lg-6 chart-container mb-4">
                      <h5 class="text-center mb-2">
                        Reported Crime Incidents by Area (Last 30 Days)
                      </h5>
                    ...
                    <div class="col-lg-6 chart-container mb-4">
                      <h5 class="text-center mb-2">
                        Weekly Usage of Safety Check Tool
                      </h5>
                    ...
                    <div class="col-lg-6 chart-container mb-4">
                      <h5 class="text-center mb-2">
                        Avg. Emergency Response Time (by Area)
                      </h5>
                    ...
                    <div class="col-lg-6 chart-container mb-4">
                      <h5 class="text-center mb-2">
                        Feedback, Safety, and Foot Traffic Analysis
                      </h5>
